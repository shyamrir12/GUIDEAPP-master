...
import static com.example.user3.guideapp.R.string.loading;
...
public class GoogleLoginActivity extends AppCompatActivity implements
    ...
    private TextView txtName, txtEmail,txtTokenid,txtid;
        ...
        if (result.isSuccess()) {
          ...
          // String personPhotoUrl = acct.getPhotoUrl().toString();
           ...
           /* Log.e(TAG, "Name: " + personName + ", email: " + email
                    + ", Image: " + personPhotoUrl+"tokenid: " + tokenid + ", id: " + id);
*/
            txtName.setText(personName);
            txtEmail.setText(email);
            //txtTokenid.setText(tokenid);
            txtid.setText(id);
